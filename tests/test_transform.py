    ...
    def test_handle_modifications_marche_all_cases(self):
        ...
        lf = pl.LazyFrame(
            [
                ...
                # Case 2: uid=2 with 1 modification (partial update: only dureeMois)
                {
                    "uid": 2,
                    "montant": 2000,
                    "dureeMois": 24,
                ...
                # Case 3: uid=3 with no modifications (all modification fields are None)
                {
                    "uid": 3,
                    "acheteur_id": "99999",
                    "montant": 500,
        ...
        expected_df = pl.DataFrame(
            [
                # uid=1: 3 rows (original + 2 modifications)
                {
                    "uid": 1,
                ...
                # uid=2: 2 rows (original + 1 modification)
                {
                    "uid": 2,
